...
async def send_keyboard_button(client, tag: str, msg, keyword: str) -> bool:
    # Debug: print semua button yang ada
    try:
        if msg.reply_markup and hasattr(msg.reply_markup, "keyboard"):
            all_btns = [btn if isinstance(btn, str) else btn.text for row in msg.reply_markup.keyboard for btn in row]
        ...
        try:
            ...
            if not emoji_answer:
                ...
                if matches:
                    ...
                    print(f"{tag} [Fuzzy] '{word}' → '{matches[0]}'")
            ...
            # 11. Yes
            await send_keyboard_button(client, tag, msg, "Yes")
            msg = await listener.wait()

            # 12. I Have Joined
            await send_keyboard_button(client, tag, msg, "I Have Joined")
            msg = await listener.wait()

            # 13. Joined!
            await send_keyboard_button(client, tag, msg, "Joined")
