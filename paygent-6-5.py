...
async def run(idx):
    ...
    try:
        async with app:
            ...
            msg = await wait_msg(app)
            await app.send_message(BOT, "Done")    # ReplyKeyboard button
            msg = await wait_msg(app)
            ...
            await app.send_message(BOT, "Yes")     # ReplyKeyboard button
            msg = await wait_msg(app)
            ...
            await app.send_message(BOT, "Complete the Airdrop")   # ReplyKeyboard button
    ...
    while True:
        ...
        if choice == "1":
            try:
                ...
                if 1 <= n <= total:
                    return [n - 1]          # konversi ke 0-based
            ...
            try:
                ...
                if 1 <= n <= total:
                    return list(range(n - 1, total))   # konversi ke 0-based
                print(f"  ✗ Nomor harus 1–{total}")
            except ValueError:
                print("  ✗ Masukkan angka yang valid.")
